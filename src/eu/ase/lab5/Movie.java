...
public class Movie implements Cloneable, Comparable<Movie> {
	...
	public String toString() {
		return String.format("The movie %s from %d has a rating of %.1f", this.getTitle(), this.getYear(), this.getRating());
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof Movie) {
			...
			return this.getYear() == movie.getYear() && this.getTitle().equals(movie.getTitle()) && this.getRating() == movie.getRating();
